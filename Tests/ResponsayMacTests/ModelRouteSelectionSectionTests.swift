...
final class ModelRouteSelectionSectionTests: XCTestCase {
    func testLLMSelectionResetsModelWhenSwitchingProviderFromStaleMimo() {
        ...
        XCTAssertEqual(defaults.string(forKey: "byok.llm.model"), "deepseek-v4-flash")
        XCTAssertEqual(defaults.string(forKey: "byok.llm.baseURL"), "https://api.deepseek.com/v1")
    }
    ...
    func testLLMSelectionResetsModelWhenSwitchingProviderFromStaleDoubao() {
        ...
        defaults.set("doubao-seed-1-6", forKey: "byok.llm.model")
        defaults.set("https://ark.cn-beijing.volces.com/api/v3", forKey: "byok.llm.baseURL")
        ...
        XCTAssertEqual(defaults.string(forKey: "byok.llm.model"), "mimo-v2.5")
        XCTAssertEqual(defaults.string(forKey: "byok.llm.baseURL"), "https://token-plan-cn.xiaomimimo.com/v1")
    }
    ...
    func testLLMSelectionWithPlanTagSwitchesPlanAndEndpoint() {
        ...
        XCTAssertEqual(defaults.string(forKey: "byok.llm.baseURL"), "https://api.xiaomimimo.com/v1")

        ModelRouteSelectionActions.applyLLMSelection("mimo#package", defaults: defaults)
        XCTAssertEqual(defaults.string(forKey: "byok.llm.provider"), "mimo")
        XCTAssertEqual(defaults.string(forKey: "byok.llm.plan"), BillingPlan.package.rawValue)
        XCTAssertEqual(defaults.string(forKey: "byok.llm.baseURL"), "https://token-plan-cn.xiaomimimo.com/v1")
    }
