...
allowed_path() {
  case "$1" in
    ...
    Packages/ResponsayCore/*|Tests/ResponsayMacTests/*|macOS/*)
      return 0
      ;;
    scripts/fetch-sherpa-onnx.sh|scripts/release-macos.sh|scripts/publish-update-r2.sh|scripts/publish-update-r2.test.mjs|scripts/ci/public-source-gate.sh|scripts/ci/scan-secrets.sh)
      return 0
      ;;
