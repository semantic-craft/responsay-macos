...
Depot is intentionally limited to portable source, policy, and deterministic secret guards. Do not add Linux Swift or Xcode substitutes and call them macOS validation. The authoritative native gates run on Buildkite's hosted Apple Silicon macOS queue.
